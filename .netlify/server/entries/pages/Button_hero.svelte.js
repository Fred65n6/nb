...
var Button_hero_svelte_svelte_type_style_lang = "";
const css = {
...
const Button_hero = (0, import_index_72c3c0a2.c)(($$result, $$props, $$bindings, slots) => {
  let { link } = $$props;
  if ($$props.link === void 0 && $$bindings.link && link !== void 0)
    $$bindings.link(link);
  $$result.css.add(css);
  return `<a class="${"btn svelte-1aghrhe"}"${(0, import_index_72c3c0a2.d)("href", link, 0)}><svg class="${"svelte-1aghrhe"}"><rect x="${"0"}" y="${"0"}" fill="${"none"}" width="${"166"}" height="${"45"}" class="${"svelte-1aghrhe"}"></rect></svg>
