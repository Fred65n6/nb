...
var Modal_by_svelte_svelte_type_style_lang = "";
const css = {
...
let onTop;
const modals = {};
function getModalBy(id = "") {
  return modals[id];
}
const Modal_by = (0, import_index_f5faca1c.c)(($$result, $$props, $$bindings, slots) => {
  let topDiv;
  let visible = false;
  let prevOnTop;
  let closeCallback;
