...
const Shop_item = (0, import_index_df09d767.c)(($$result, $$props, $$bindings, slots) => {
  let { img } = $$props;
  let { titel } = $$props;
  let { sub_titel } = $$props;
  let { pris } = $$props;
  ...
  if ($$props.pris === void 0 && $$bindings.pris && pris !== void 0)
    $$bindings.pris(pris);
  $$result.css.add(css);
  return `<div class="${"card svelte-e63xnm"}"><img${(0, import_index_df09d767.d)("src", img, 0)} alt="${""}" class="${"svelte-e63xnm"}">
	<h3 class="${"svelte-e63xnm"}">${(0, import_index_df09d767.e)(titel)}</h3>
	<p class="${"svelte-e63xnm"}">${(0, import_index_df09d767.e)(sub_titel)}</p>
	<h3 class="${"svelte-e63xnm"}">${(0, import_index_df09d767.e)(pris)}</h3>
	<div class="${"flex gap-4"}"><button class="${"font-xl"}">-</button>
		<span class="${"bg-white px-4 border-2"}">${(0, import_index_df09d767.e)(count)}</span>
		<button>+</button></div>
	${(0, import_index_df09d767.v)(import_Button_black_svelte.default, "ButtonBlack").$$render($$result, {}, {}, {
    default: () => {
