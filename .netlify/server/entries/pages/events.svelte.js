...
var import_Modal_by_svelte = __toESM(require("./Modal_by.svelte.js"));
...
const Events = (0, import_index_f5faca1c.c)(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
...
${(0, import_index_f5faca1c.v)(import_Modal_smag_svelte.default, "Modal_smag").$$render($$result, {}, {}, {
    default: () => {
      return `<h1>Smag</h1>
...
${(0, import_index_f5faca1c.v)(import_Modal_dj_svelte.default, "Modal_dj").$$render($$result, {}, {}, {
    default: () => {
      return `<h1>DJ</h1>
	<p>Your selection was:</p>`;
    }
...
${(0, import_index_f5faca1c.v)(import_Modal_by_svelte.default, "Modal_by").$$render($$result, {}, {}, {
    default: () => {
      return `<h1>By</h1>
	<p>Your selection was:</p>`;
    }
...
<section class="${"kalender svelte-1nokq14"}"><button><div class="${"smag svelte-1nokq14"}">${(0, import_index_f5faca1c.v)(import_Event_card_svelte.default, "Event_card").$$render($$result, {
    dato: "4/5/2022",
    img: "smag_blomst.svg",
    titel: "\xF8lsmagning",
	...
	<button><div class="${"by svelte-1nokq14"}">${(0, import_index_f5faca1c.v)(import_Event_card_svelte.default, "Event_card").$$render($$result, {
    dato: "6/5/2022",
    img: "by_blomst.svg",
	...
	<button><div class="${"dj svelte-1nokq14"}">${(0, import_index_f5faca1c.v)(import_Event_card_svelte.default, "Event_card").$$render($$result, {
    dato: "7/5/2022",
    img: "dj_blomst.svg",
	...
	<button><div class="${"smag svelte-1nokq14"}">${(0, import_index_f5faca1c.v)(import_Event_card_svelte.default, "Event_card").$$render($$result, {
    dato: "11/5/2022",
    img: "smag_blomst.svg",
    titel: "\xF8lsmagning",
    sub_titel: "En smagsoplevelse i \xF8llets verden",
